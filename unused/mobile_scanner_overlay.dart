...
import 'package:vego_flutter_project/barcode_scanner_page/scanned_barcode_label.dart';
        ...
        children: [
          Center(
            child: MobileScanner(
              ...
              overlayBuilder: (final context, final constraints) {
                return Padding(
...
class ScannerOverlay extends CustomPainter {
  ...
  void paint(final Canvas canvas, final Size size) {
    // TO DO: use `Offset.zero & size` instead of Rect.largest
  ...
  @override
  bool shouldRepaint(final ScannerOverlay oldDelegate) {
