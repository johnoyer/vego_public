...
class DietDetailPage extends StatelessWidget {
    ...
    return SafeArea(
      child: Consumer<DietState>(builder: (final context, final dietState, final _) {
        ...
        return isAndroid() ? Scaffold(
          appBar: AppBar(
            title: Text('$dietName Diet Details'),
          ),
          body: Center(
          ...
          navigationBar: CupertinoNavigationBar(
            middle: Text('$dietName Diet Details'),
          ),
          child: _buildPage(context)
          );
      }),
  ...
  Widget _buildPage(final BuildContext context) {
    return Column(
      ...
      children: [
        isAndroid() ? Container() : const Padding(padding: EdgeInsets.only(top: 50)),
        ...
        : Padding(
          padding: const EdgeInsets.all(8.0),
          child: isAndroid() ? editDietAndroidbutton(context, dietIndex) : editDietIOSbutton(context, dietIndex)
        ),
      ],
    );
  }
